        ...
        <div>
            ...
            <div className="md:mt-16 p-10 md:flex md:justify-around">
                <div className="mt-24 pb-14 px-5 w-fit">
                    ...
                    <button className="text-white mt-5 p-2 text-sm md:p-3 md:text-xl font-bold ml-5 md:ml-24 rounded-xl" style={{ backgroundColor: "#00786f" }}> <i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
