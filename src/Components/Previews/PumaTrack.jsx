        ...
        <div>
            ...
            <div className="md:mt-16 p-10 md:flex md:justify-around">
                <div className="mt-24 pb-14 px-5 w-fit">
                    <img src={fashion9} alt="" className="md:ml-20 md:w-96 w-80"/>
                ...
                <div className="md:mt-36 md:text-xl text-sm flex flex-col gap-3 md:w-96">
                    ...
                    <p><span className="text-3xl">₹1,999</span> <s className="mx-2">₹4,000 </s> <b className="text-green-800">10% off</b> </p>
                </div>
            </div>
        </div>
    )
}
export default PumaTrack